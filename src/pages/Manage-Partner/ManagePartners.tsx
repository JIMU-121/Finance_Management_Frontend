        ...
        <div className="space-y-6 p-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <Input value={partnershipType} onChange={(e: any) => setPartnershipType(e.target.value)} placeholder="e.g. LLC, General" />
            </div>
            <div>
            ...
            <div className="flex items-center pt-8">
              <label className="flex items-center cursor-pointer select-none text-gray-700 dark:text-gray-300">
                <div className="relative">
                  ...
                  />
                  <div className={`box block h-6 w-10 rounded-full ${isMainPartner ? 'bg-blue-600' : 'bg-gray-200 dark:bg-gray-700'}`}></div>
                  <div className={`absolute left-1 top-1 flex h-4 w-4 items-center justify-center rounded-full bg-white transition ${isMainPartner ? 'translate-x-full' : ''}`}></div>
                </div>
