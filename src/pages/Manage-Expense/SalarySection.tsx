...
export function SalarySection({ employees, setEmployees, loading }: SalarySectionProps) {
  if (loading) {
  ...
  return (
    <div>
      ...
      {/* All-paid banner */}
      {allUnpaidPaid && (
        <div className="mb-3 rounded-xl border border-green-200 bg-green-50 px-4 py-2.5 dark:border-green-800/50 dark:bg-green-900/20">
      ...
      {employees.length === 0 ? (
        ...
        <div className="divide-y divide-gray-100 rounded-xl border border-gray-200 dark:border-gray-700 dark:divide-gray-700/50 max-h-72 overflow-y-auto">
          {employees.map((emp, i) => (
            <div
              key={emp.employeeId}
              onClick={() => { if (!emp.alreadyPaid) toggleOne(i); }}
            ...
            >
              <input
                ...
                onChange={() => { if (!emp.alreadyPaid) toggleOne(i); }}
              ...
              {emp.alreadyPaid ? (
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <input
                    ...
                    onClick={(e) => e.stopPropagation()}
                    onChange={(e) =>
                      updateAmount(i, e.target.value.replace(/[^0-9]/g, ""))
                    }
